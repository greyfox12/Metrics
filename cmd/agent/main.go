...
func main() {
	...
	for {
		...
		ListGauge[25] = post.GaugeMetric{Name: "HeapInuse", Val: post.Gauge(m.HeapInuse)}
		ListGauge[25] = post.GaugeMetric{Name: "MSpanInuse", Val: post.Gauge(m.MSpanInuse)}
		ListGauge[25] = post.GaugeMetric{Name: "MSpanSys", Val: post.Gauge(m.MSpanSys)}
